...
<!--ACTION:{"tipo":"nova_oportunidade","clienteNome":"Ricardo Zarpellon","clienteTelefone":"42999989582","clienteTipoPessoa":"PJ","clienteEmail":"contato@empresa.com","clienteCpfCnpj":"00.000.000/0001-00","clienteRazaoSocial":"Empresa Ltda","clienteCep":"80240-000","clienteNumero":"2775","clienteComplemento":"loja 303","titulo":"Sucão Shopping Estação RETROFIT","descricao":"Reforma de imóvel comercial 12m². Serviços: demolições, elétrica, iluminação, portas, revestimentos, pintura, marcenaria, comunicação visual, serralheria.","cepObra":"80240-000","numeroEnderecoObra":"2775","complementoObra":"loja 303","tipoObra":"comercial","origem":"outros"}-->
...
Para endereços: preencha APENAS clienteCep + clienteNumero + clienteComplemento e/ou cepObra + numeroEnderecoObra + complementoObra. NUNCA preencha rua, bairro, cidade ou estado — o sistema busca via ViaCEP automaticamente a partir do CEP.
Se o endereço do cliente e o da obra parecerem o mesmo, preencha o mesmo CEP em clienteCep e cepObra com os respectivos número/complemento.
